...
/**
 * RedBoilerFarContourDectection class.
 *
 * <p>
...
public class RedBoiler {
  ...
  public void process(Mat source0) {
    ...
    double[] hsvThresholdHue = { 115.25423728813561, 180.0 };
    double[] hsvThresholdSaturation = { 67.2316384180791, 255.0 };
  ...
  private void blur(Mat input, BlurType type, double doubleRadius, Mat output) {
    ...
    case GAUSSIAN:
      ...
      Imgproc.GaussianBlur(input, output, new Size(kernelSize, kernelSize),
          radius);
      break;
    case MEDIAN:
      kernelSize = 2 * radius + 1;
  ...
  public ArrayList<Contour> getContourOfMoP(List<MatOfPoint> input) {
    ArrayList<Contour> contours = new ArrayList<Contour>();
    for (MatOfPoint p : input) {
      Contour c = new Contour(p.toArray());
      contours.add(c);
    }
    return contours;
  }
